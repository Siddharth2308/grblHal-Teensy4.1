...
#define BUILD_INFO "OLSK LARGE LASER V2"
#endif
...
#define DEFAULT_CONTROL_SIGNALS_INVERT_MASK SIGNALS_SAFETYDOOR_BIT // Set to SIGNALS_BITMASK or -1 to invert all signals
#endif
///@}
...
#define DEFAULT_LIMIT_SIGNALS_INVERT_MASK 7 // Set to -1 or AXES_BITMASK to invert for all axes
#endif
///@}
...
#define DEFAULT_HOMING_FEED_RATE 1000.0f // mm/min
#endif
///@}
...
#define DEFAULT_HOMING_CYCLE_1 (X_AXIS_BIT)  // OPTIONAL: Then move X,Y at the same time.
#endif
#endif
///@}
...
#else
#define DEFAULT_HOMING_CYCLE_2 (Y_AXIS_BIT)            // OPTIONAL: Uncomment and add axes mask to enable
#endif
#endif
///@}
...
#define DEFAULT_DIR_SIGNALS_INVERT_MASK 7
#endif
///@}
...
#define DEFAULT_X_STEPS_PER_MM 103.42f
#endif
#if !defined DEFAULT_Y_STEPS_PER_MM || defined __DOXYGEN__
#define DEFAULT_Y_STEPS_PER_MM 113.78f
#endif
...
#define DEFAULT_X_MAX_TRAVEL 1015.0f // mm
#endif
#if !defined DEFAULT_Y_MAX_TRAVEL || defined __DOXYGEN__
#define DEFAULT_Y_MAX_TRAVEL 615.0f // mm
#endif
